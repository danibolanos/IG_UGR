...
//**********************************************************************
// Clase FuenteDireccional que hereda de FuenteLuz
...
//**********************************************************************
// Clase FuentePosicional que hereda de FuenteLuz
...
//**********************************************************************
// Clases para los materiales de la escena de la P3

class MaterialAcero : public Material
{
  public:
    MaterialAcero() ;
};

class MaterialAceroRojo : public Material
{
  public:
    MaterialAceroRojo() ;
};

class MaterialCristal : public Material
{
  public:
    MaterialCristal() ;
};

class MaterialCabina : public Material
{
  public:
    MaterialCabina() ;
};

class MaterialSemipinza : public Material
{
  public:
    MaterialSemipinza() ;
};
...
//**********************************************************************
// Clases para los materiales de la escena de la P4
