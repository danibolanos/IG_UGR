...
void P2_Inicializar(  )
{
   ...
   objetos2[0] = new Cilindro(2, 50, true, true, false);
   objetos2[1] = new Cono(2, 50, true, true, false);
   objetos2[2] = new Esfera(20, 50, true, true, false);
   objetos2[3] = new MallaRevol("../plys/peon.ply", 50, true, true, false);
